import { p as process, B as Buffer } from './common/process-c22ef109.js';
...
var Pair = /*#__PURE__*/function (_Node) {
  ...
  _createClass(Pair, [{
    ...
    value: function toString(ctx, onComment, onChompKeep) {
      ...
      var explicitKey = !simpleKeys && (!key || keyComment || (key instanceof Node$1 ? key instanceof Collection$1 || key.type === Type.BLOCK_FOLDED || key.type === Type.BLOCK_LITERAL : _typeof(key) === 'object'));
      var _ctx = ctx,
          doc = _ctx.doc,
          indent = _ctx.indent,
          indentStep = _ctx.indentStep,
